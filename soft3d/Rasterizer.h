...
namespace soft3d
{
	...
	public:
		...
		void Fragment(vmath::vec4* out_color, uint32 src0, uint32 src1, float ratio);
		void Fragment(vmath::vec4* out_color, uint32 src0, uint32 src1, uint32 src2, float ratio0, float ratio1);

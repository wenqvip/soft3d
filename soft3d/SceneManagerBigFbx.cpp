...
namespace soft3d
{
	...
	void SceneManagerBigFbx::InitScene(uint16_t width, uint16_t height)
	{
		m_width = width;
		m_height = height;
		...
		Soft3dPipeline::Instance()->AddKeyboardEventCB(std::bind(&SceneManagerBigFbx::KeyboardEventCB, this, std::placeholders::_1));
	}
